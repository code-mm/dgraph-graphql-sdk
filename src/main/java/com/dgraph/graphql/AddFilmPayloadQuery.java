...
* 
*/
public class AddFilmPayloadQuery extends Query<AddFilmPayloadQuery> {
    AddFilmPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddFilmPayloadQuery film(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public AddFilmPayloadQuery film(FilmArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("film");
