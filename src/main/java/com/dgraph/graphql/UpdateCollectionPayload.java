...
* 
*/
public class UpdateCollectionPayload extends AbstractResponse<UpdateCollectionPayload> {
    public UpdateCollectionPayload() {
    }

    public UpdateCollectionPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateCollectionPayload setCollection(List<Collection> arg) {
