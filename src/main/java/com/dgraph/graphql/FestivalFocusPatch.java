...
public class FestivalFocusPatch implements Serializable {
    ...
    public FestivalFocusPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalFocusPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public FestivalFocusPatch setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalFocusPatch setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
