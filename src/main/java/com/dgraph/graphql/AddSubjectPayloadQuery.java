...
* 
*/
public class AddSubjectPayloadQuery extends Query<AddSubjectPayloadQuery> {
    AddSubjectPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddSubjectPayloadQuery subject(SubjectQueryDefinition queryDef) {
    ...
    * 
    */
    public AddSubjectPayloadQuery subject(SubjectArgumentsDefinition argsDef, SubjectQueryDefinition queryDef) {
        startField("subject");
