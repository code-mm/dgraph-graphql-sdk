...
* 
*/
public class CinematographerQuery extends Query<CinematographerQuery> {
    CinematographerQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public CinematographerQuery id() {
        startField("id");
    ...
    * 
    */
    public CinematographerQuery name() {
        startField("name");
    ...
    * 
    */
    public CinematographerQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public CinematographerQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
