...
* 
*/
public class UpdateCollectionPayloadQuery extends Query<UpdateCollectionPayloadQuery> {
    UpdateCollectionPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCollectionPayloadQuery collection(CollectionQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCollectionPayloadQuery collection(CollectionArgumentsDefinition argsDef, CollectionQueryDefinition queryDef) {
