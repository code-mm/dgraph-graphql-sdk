...
public class CrewMemberPatch implements Serializable {
    ...
    public CrewMemberPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CrewMemberPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CrewMemberPatch setFilmsCrewed(List<FilmRef> filmsCrewed) {
        this.filmsCrewed = Input.optional(filmsCrewed);
        return this;
    }

    public CrewMemberPatch setFilmsCrewedInput(Input<List<FilmRef>> filmsCrewed) {
        if (filmsCrewed == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
