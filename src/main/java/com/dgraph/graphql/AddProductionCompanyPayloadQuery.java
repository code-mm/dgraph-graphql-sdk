...
* 
*/
public class AddProductionCompanyPayloadQuery extends Query<AddProductionCompanyPayloadQuery> {
    AddProductionCompanyPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProductionCompanyPayloadQuery productioncompany(ProductionCompanyQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductionCompanyPayloadQuery productioncompany(ProductioncompanyArgumentsDefinition argsDef, ProductionCompanyQueryDefinition queryDef) {
