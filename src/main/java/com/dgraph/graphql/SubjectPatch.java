...
public class SubjectPatch implements Serializable {
    ...
    public SubjectPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SubjectPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public SubjectPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SubjectPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
