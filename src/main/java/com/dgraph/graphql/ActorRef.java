...
public class ActorRef implements Serializable {
    ...
    public ActorRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public ActorRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public ActorRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public ActorRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public ActorRef setPerformances(List<PerformanceRef> performances) {
        this.performances = Input.optional(performances);
        return this;
    }

    public ActorRef setPerformancesInput(Input<List<PerformanceRef>> performances) {
    ...
    public ActorRef setDubbingPerformances(List<FilmRef> dubbingPerformances) {
        this.dubbingPerformances = Input.optional(dubbingPerformances);
        return this;
    }

    public ActorRef setDubbingPerformancesInput(Input<List<FilmRef>> dubbingPerformances) {
