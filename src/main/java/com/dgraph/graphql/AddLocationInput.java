...
public class AddLocationInput implements Serializable {
    ...
    public AddLocationInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddLocationInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddLocationInput setFeaturedInFilms(List<FilmRef> featuredInFilms) {
        this.featuredInFilms = Input.optional(featuredInFilms);
        return this;
    }

    public AddLocationInput setFeaturedInFilmsInput(Input<List<FilmRef>> featuredInFilms) {
