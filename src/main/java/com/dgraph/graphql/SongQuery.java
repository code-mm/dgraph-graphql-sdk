...
* 
*/
public class SongQuery extends Query<SongQuery> {
    SongQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public SongQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public SongQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
