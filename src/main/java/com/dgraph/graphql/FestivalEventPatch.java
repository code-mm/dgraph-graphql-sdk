...
public class FestivalEventPatch implements Serializable {
    ...
    public FestivalEventPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalEventPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public FestivalEventPatch setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalEventPatch setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public FestivalEventPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public FestivalEventPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
