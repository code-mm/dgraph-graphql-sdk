...
public class ProducerPatch implements Serializable {
    ...
    public ProducerPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public ProducerPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public ProducerPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public ProducerPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public ProducerPatch setFilmsExecutiveProduced(List<FilmRef> filmsExecutiveProduced) {
        this.filmsExecutiveProduced = Input.optional(filmsExecutiveProduced);
        return this;
    }

    public ProducerPatch setFilmsExecutiveProducedInput(Input<List<FilmRef>> filmsExecutiveProduced) {
