...
* 
*/
public class UpdateSetDecoratorPayloadQuery extends Query<UpdateSetDecoratorPayloadQuery> {
    UpdateSetDecoratorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateSetDecoratorPayloadQuery setdecorator(SetDecoratorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateSetDecoratorPayloadQuery setdecorator(SetdecoratorArgumentsDefinition argsDef, SetDecoratorQueryDefinition queryDef) {
