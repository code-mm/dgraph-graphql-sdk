...
* 
*/
public class EditorQuery extends Query<EditorQuery> {
    EditorQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public EditorQuery film(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public EditorQuery film(FilmArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("film");
