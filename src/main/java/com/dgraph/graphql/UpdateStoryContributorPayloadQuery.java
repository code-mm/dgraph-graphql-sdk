...
* 
*/
public class UpdateStoryContributorPayloadQuery extends Query<UpdateStoryContributorPayloadQuery> {
    UpdateStoryContributorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateStoryContributorPayloadQuery storycontributor(StoryContributorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateStoryContributorPayloadQuery storycontributor(StorycontributorArgumentsDefinition argsDef, StoryContributorQueryDefinition queryDef) {
