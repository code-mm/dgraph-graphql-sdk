...
public class FestivalFocusRef implements Serializable {
    ...
    public FestivalFocusRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public FestivalFocusRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public FestivalFocusRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalFocusRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public FestivalFocusRef setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalFocusRef setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
