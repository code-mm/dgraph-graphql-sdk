...
public class AddCompanyInput implements Serializable {
    ...
    public AddCompanyInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddCompanyInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddCompanyInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddCompanyInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
