...
* 
*/
public class AddSongPerformerPayload extends AbstractResponse<AddSongPerformerPayload> {
    public AddSongPerformerPayload() {
    }

    public AddSongPerformerPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddSongPerformerPayload";
    }
    ...
    */
    ...
    public AddSongPerformerPayload setSongperformer(List<SongPerformer> arg) {
