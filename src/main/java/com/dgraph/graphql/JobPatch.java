...
public class JobPatch implements Serializable {
    ...
    public JobPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public JobPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public JobPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public JobPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
