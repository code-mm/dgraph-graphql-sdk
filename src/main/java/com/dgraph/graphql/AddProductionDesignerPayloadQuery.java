...
* 
*/
public class AddProductionDesignerPayloadQuery extends Query<AddProductionDesignerPayloadQuery> {
    AddProductionDesignerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProductionDesignerPayloadQuery productiondesigner(ProductionDesignerQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProductionDesignerPayloadQuery productiondesigner(ProductiondesignerArgumentsDefinition argsDef, ProductionDesignerQueryDefinition queryDef) {
