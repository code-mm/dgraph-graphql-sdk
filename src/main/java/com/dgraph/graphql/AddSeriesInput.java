...
public class AddSeriesInput implements Serializable {
    ...
    public AddSeriesInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddSeriesInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddSeriesInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddSeriesInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
