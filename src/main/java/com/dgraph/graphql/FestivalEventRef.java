...
public class FestivalEventRef implements Serializable {
    ...
    public FestivalEventRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public FestivalEventRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public FestivalEventRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalEventRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public FestivalEventRef setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalEventRef setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public FestivalEventRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public FestivalEventRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
