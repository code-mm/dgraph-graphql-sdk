...
* 
*/
public class AddPersonalAppearanceTypePayloadQuery extends Query<AddPersonalAppearanceTypePayloadQuery> {
    AddPersonalAppearanceTypePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddPersonalAppearanceTypePayloadQuery personalappearancetype(PersonalAppearanceTypeQueryDefinition queryDef) {
    ...
    * 
    */
    public AddPersonalAppearanceTypePayloadQuery personalappearancetype(PersonalappearancetypeArgumentsDefinition argsDef, PersonalAppearanceTypeQueryDefinition queryDef) {
