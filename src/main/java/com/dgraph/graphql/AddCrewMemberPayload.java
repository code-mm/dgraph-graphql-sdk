...
* 
*/
public class AddCrewMemberPayload extends AbstractResponse<AddCrewMemberPayload> {
    public AddCrewMemberPayload() {
    }

    public AddCrewMemberPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddCrewMemberPayload setCrewmember(List<CrewMember> arg) {
