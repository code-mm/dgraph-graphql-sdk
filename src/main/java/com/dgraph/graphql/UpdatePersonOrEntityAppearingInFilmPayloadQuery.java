...
* 
*/
public class UpdatePersonOrEntityAppearingInFilmPayloadQuery extends Query<UpdatePersonOrEntityAppearingInFilmPayloadQuery> {
    UpdatePersonOrEntityAppearingInFilmPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdatePersonOrEntityAppearingInFilmPayloadQuery personorentityappearinginfilm(PersonOrEntityAppearingInFilmQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePersonOrEntityAppearingInFilmPayloadQuery personorentityappearinginfilm(PersonorentityappearinginfilmArgumentsDefinition argsDef, PersonOrEntityAppearingInFilmQueryDefinition queryDef) {
