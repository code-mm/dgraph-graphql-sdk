...
public class AddCharacterInput implements Serializable {
    ...
    public AddCharacterInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddCharacterInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddCharacterInput setPortrayedInFilms(List<FilmRef> portrayedInFilms) {
        this.portrayedInFilms = Input.optional(portrayedInFilms);
        return this;
    }

    public AddCharacterInput setPortrayedInFilmsInput(Input<List<FilmRef>> portrayedInFilms) {
    ...
    public AddCharacterInput setPortrayedInFilmsDubbed(List<FilmRef> portrayedInFilmsDubbed) {
        this.portrayedInFilmsDubbed = Input.optional(portrayedInFilmsDubbed);
        return this;
    }

    public AddCharacterInput setPortrayedInFilmsDubbedInput(Input<List<FilmRef>> portrayedInFilmsDubbed) {
