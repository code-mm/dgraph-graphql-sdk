...
* 
*/
public class FestivalFocusQuery extends Query<FestivalFocusQuery> {
    FestivalFocusQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public FestivalFocusQuery name() {
        startField("name");
    ...
    * 
    */
    public FestivalFocusQuery festivals(FestivalQueryDefinition queryDef) {
    ...
    * 
    */
    public FestivalFocusQuery festivals(FestivalsArgumentsDefinition argsDef, FestivalQueryDefinition queryDef) {
