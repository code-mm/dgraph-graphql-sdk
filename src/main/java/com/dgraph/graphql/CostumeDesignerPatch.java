...
public class CostumeDesignerPatch implements Serializable {
    ...
    public CostumeDesignerPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CostumeDesignerPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CostumeDesignerPatch setCostumeDesignForFilm(List<FilmRef> costumeDesignForFilm) {
        this.costumeDesignForFilm = Input.optional(costumeDesignForFilm);
        return this;
    }

    public CostumeDesignerPatch setCostumeDesignForFilmInput(Input<List<FilmRef>> costumeDesignForFilm) {
