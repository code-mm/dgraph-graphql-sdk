...
public class RegionalReleaseDatePatch implements Serializable {
    ...
    public RegionalReleaseDatePatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public RegionalReleaseDatePatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public RegionalReleaseDatePatch setReleaseDate(DateTime releaseDate) {
        this.releaseDate = Input.optional(releaseDate);
        return this;
    }

    public RegionalReleaseDatePatch setReleaseDateInput(Input<DateTime> releaseDate) {
        if (releaseDate == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public RegionalReleaseDatePatch setReleaseRegion(List<LocationRef> releaseRegion) {
        this.releaseRegion = Input.optional(releaseRegion);
        return this;
    }

    public RegionalReleaseDatePatch setReleaseRegionInput(Input<List<LocationRef>> releaseRegion) {
