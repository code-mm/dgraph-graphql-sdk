...
* 
*/
public class ProductionCompanyQuery extends Query<ProductionCompanyQuery> {
    ProductionCompanyQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public ProductionCompanyQuery id() {
        startField("id");
    ...
    * 
    */
    public ProductionCompanyQuery name() {
        startField("name");
    ...
    * 
    */
    public ProductionCompanyQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public ProductionCompanyQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
