...
* 
*/
public class AddSongPayloadQuery extends Query<AddSongPayloadQuery> {
    AddSongPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddSongPayloadQuery song(SongQueryDefinition queryDef) {
    ...
    * 
    */
    public AddSongPayloadQuery song(SongArgumentsDefinition argsDef, SongQueryDefinition queryDef) {
        startField("song");
