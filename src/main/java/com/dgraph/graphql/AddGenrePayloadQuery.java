...
* 
*/
public class AddGenrePayloadQuery extends Query<AddGenrePayloadQuery> {
    AddGenrePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddGenrePayloadQuery genre(GenreQueryDefinition queryDef) {
    ...
    * 
    */
    public AddGenrePayloadQuery genre(GenreArgumentsDefinition argsDef, GenreQueryDefinition queryDef) {
        startField("genre");
