...
public class EditorPatch implements Serializable {
    ...
    public EditorPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public EditorPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public EditorPatch setFilm(List<FilmRef> film) {
        this.film = Input.optional(film);
        return this;
    }

    public EditorPatch setFilmInput(Input<List<FilmRef>> film) {
        if (film == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.film = film;
