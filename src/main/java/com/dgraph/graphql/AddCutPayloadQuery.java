...
* 
*/
public class AddCutPayloadQuery extends Query<AddCutPayloadQuery> {
    AddCutPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCutPayloadQuery cut(CutQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCutPayloadQuery cut(CutArgumentsDefinition argsDef, CutQueryDefinition queryDef) {
        startField("cut");
