...
public class CrewGigPatch implements Serializable {
    ...
    public CrewGigPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CrewGigPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CrewGigPatch setCrewRole(List<JobRef> crewRole) {
        this.crewRole = Input.optional(crewRole);
        return this;
    }

    public CrewGigPatch setCrewRoleInput(Input<List<JobRef>> crewRole) {
        if (crewRole == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CrewGigPatch setCrewmember(List<CrewMemberRef> crewmember) {
        this.crewmember = Input.optional(crewmember);
        return this;
    }

    public CrewGigPatch setCrewmemberInput(Input<List<CrewMemberRef>> crewmember) {
        if (crewmember == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public CrewGigPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public CrewGigPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
