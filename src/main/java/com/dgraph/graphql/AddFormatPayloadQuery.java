...
* 
*/
public class AddFormatPayloadQuery extends Query<AddFormatPayloadQuery> {
    AddFormatPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddFormatPayloadQuery format(FormatQueryDefinition queryDef) {
    ...
    * 
    */
    public AddFormatPayloadQuery format(FormatArgumentsDefinition argsDef, FormatQueryDefinition queryDef) {
        startField("format");
