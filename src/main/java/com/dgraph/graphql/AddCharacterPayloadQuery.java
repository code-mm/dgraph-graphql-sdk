...
* 
*/
public class AddCharacterPayloadQuery extends Query<AddCharacterPayloadQuery> {
    AddCharacterPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCharacterPayloadQuery character(CharacterQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCharacterPayloadQuery character(CharacterArgumentsDefinition argsDef, CharacterQueryDefinition queryDef) {
