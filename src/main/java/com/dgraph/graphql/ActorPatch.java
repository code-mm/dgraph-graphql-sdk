...
public class ActorPatch implements Serializable {
    ...
    public ActorPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public ActorPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public ActorPatch setPerformances(List<PerformanceRef> performances) {
        this.performances = Input.optional(performances);
        return this;
    }

    public ActorPatch setPerformancesInput(Input<List<PerformanceRef>> performances) {
    ...
    public ActorPatch setDubbingPerformances(List<FilmRef> dubbingPerformances) {
        this.dubbingPerformances = Input.optional(dubbingPerformances);
        return this;
    }

    public ActorPatch setDubbingPerformancesInput(Input<List<FilmRef>> dubbingPerformances) {
