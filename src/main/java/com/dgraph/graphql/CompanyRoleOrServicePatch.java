...
public class CompanyRoleOrServicePatch implements Serializable {
    ...
    public CompanyRoleOrServicePatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CompanyRoleOrServicePatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CompanyRoleOrServicePatch setCompaniesPerformingThisRoleOrService(List<CompanyRef> companiesPerformingThisRoleOrService) {
        this.companiesPerformingThisRoleOrService = Input.optional(companiesPerformingThisRoleOrService);
        return this;
    }

    public CompanyRoleOrServicePatch setCompaniesPerformingThisRoleOrServiceInput(Input<List<CompanyRef>> companiesPerformingThisRoleOrService) {
