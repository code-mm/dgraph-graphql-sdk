...
public class AddRatingInput implements Serializable {
    ...
    public AddRatingInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddRatingInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddRatingInput setCountry(List<LocationRef> country) {
        this.country = Input.optional(country);
        return this;
    }

    public AddRatingInput setCountryInput(Input<List<LocationRef>> country) {
        if (country == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddRatingInput setMinimumAccompaniedAge(Integer minimumAccompaniedAge) {
        this.minimumAccompaniedAge = Input.optional(minimumAccompaniedAge);
        return this;
    }

    public AddRatingInput setMinimumAccompaniedAgeInput(Input<Integer> minimumAccompaniedAge) {
    ...
    public AddRatingInput setMinimumUnaccompaniedAge(Integer minimumUnaccompaniedAge) {
        this.minimumUnaccompaniedAge = Input.optional(minimumUnaccompaniedAge);
        return this;
    }

    public AddRatingInput setMinimumUnaccompaniedAgeInput(Input<Integer> minimumUnaccompaniedAge) {
    ...
    public AddRatingInput setRatingSystem(List<RatingSystemRef> ratingSystem) {
        this.ratingSystem = Input.optional(ratingSystem);
        return this;
    }

    public AddRatingInput setRatingSystemInput(Input<List<RatingSystemRef>> ratingSystem) {
