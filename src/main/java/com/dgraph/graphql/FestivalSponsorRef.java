...
public class FestivalSponsorRef implements Serializable {
    ...
    public FestivalSponsorRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public FestivalSponsorRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public FestivalSponsorRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalSponsorRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public FestivalSponsorRef setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalSponsorRef setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
