...
* 
*/
public class AddFestivalEventPayloadQuery extends Query<AddFestivalEventPayloadQuery> {
    AddFestivalEventPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddFestivalEventPayloadQuery festivalevent(FestivalEventQueryDefinition queryDef) {
    ...
    * 
    */
    public AddFestivalEventPayloadQuery festivalevent(FestivaleventArgumentsDefinition argsDef, FestivalEventQueryDefinition queryDef) {
