...
public class AddCutInput implements Serializable {
    ...
    public AddCutInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddCutInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddCutInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddCutInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public AddCutInput setNote(String note) {
        this.note = Input.optional(note);
        return this;
    }

    public AddCutInput setNoteInput(Input<String> note) {
        if (note == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.note = note;
    ...
    public AddCutInput setReleaseRegion(List<LocationRef> releaseRegion) {
        this.releaseRegion = Input.optional(releaseRegion);
        return this;
    }

    public AddCutInput setReleaseRegionInput(Input<List<LocationRef>> releaseRegion) {
    ...
    public AddCutInput setRuntime(Double runtime) {
        this.runtime = Input.optional(runtime);
        return this;
    }

    public AddCutInput setRuntimeInput(Input<Double> runtime) {
        if (runtime == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddCutInput setTypeOfCut(List<CutTypeRef> typeOfCut) {
        this.typeOfCut = Input.optional(typeOfCut);
        return this;
    }

    public AddCutInput setTypeOfCutInput(Input<List<CutTypeRef>> typeOfCut) {
        if (typeOfCut == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
