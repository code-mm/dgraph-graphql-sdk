...
* 
*/
public class DirectorQuery extends Query<DirectorQuery> {
    DirectorQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public DirectorQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public DirectorQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
