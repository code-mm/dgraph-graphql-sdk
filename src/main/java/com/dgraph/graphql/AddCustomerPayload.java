...
* 
*/
public class AddCustomerPayload extends AbstractResponse<AddCustomerPayload> {
    public AddCustomerPayload() {
    }

    public AddCustomerPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddCustomerPayload setCustomer(List<Customer> arg) {
    ...
    */
    ...
    public AddCustomerPayload setNumUids(Integer arg) {
