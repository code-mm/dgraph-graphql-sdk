...
* 
*/
public class AddCutTypePayloadQuery extends Query<AddCutTypePayloadQuery> {
    AddCutTypePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCutTypePayloadQuery cuttype(CutTypeQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCutTypePayloadQuery cuttype(CuttypeArgumentsDefinition argsDef, CutTypeQueryDefinition queryDef) {
        startField("cuttype");
