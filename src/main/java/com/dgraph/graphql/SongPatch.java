...
public class SongPatch implements Serializable {
    ...
    public SongPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SongPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public SongPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SongPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
