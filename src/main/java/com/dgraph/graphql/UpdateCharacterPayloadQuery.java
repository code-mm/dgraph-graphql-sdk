...
* 
*/
public class UpdateCharacterPayloadQuery extends Query<UpdateCharacterPayloadQuery> {
    UpdateCharacterPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCharacterPayloadQuery character(CharacterQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCharacterPayloadQuery character(CharacterArgumentsDefinition argsDef, CharacterQueryDefinition queryDef) {
