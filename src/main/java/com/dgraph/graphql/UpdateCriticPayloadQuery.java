...
* 
*/
public class UpdateCriticPayloadQuery extends Query<UpdateCriticPayloadQuery> {
    UpdateCriticPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCriticPayloadQuery critic(CriticQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCriticPayloadQuery critic(CriticArgumentsDefinition argsDef, CriticQueryDefinition queryDef) {
        startField("critic");
