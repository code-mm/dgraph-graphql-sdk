...
public class RatingSystemPatch implements Serializable {
    ...
    public RatingSystemPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public RatingSystemPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public RatingSystemPatch setRatings(List<RatingRef> ratings) {
        this.ratings = Input.optional(ratings);
        return this;
    }

    public RatingSystemPatch setRatingsInput(Input<List<RatingRef>> ratings) {
        if (ratings == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public RatingSystemPatch setJurisdiction(List<LocationRef> jurisdiction) {
        this.jurisdiction = Input.optional(jurisdiction);
        return this;
    }

    public RatingSystemPatch setJurisdictionInput(Input<List<LocationRef>> jurisdiction) {
