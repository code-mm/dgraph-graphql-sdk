...
* 
*/
public class UpdateFestivalSponsorshipPayloadQuery extends Query<UpdateFestivalSponsorshipPayloadQuery> {
    UpdateFestivalSponsorshipPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateFestivalSponsorshipPayloadQuery festivalsponsorship(FestivalSponsorshipQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateFestivalSponsorshipPayloadQuery festivalsponsorship(FestivalsponsorshipArgumentsDefinition argsDef, FestivalSponsorshipQueryDefinition queryDef) {
