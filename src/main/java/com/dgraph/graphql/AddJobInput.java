...
public class AddJobInput implements Serializable {
    ...
    public AddJobInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddJobInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddJobInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddJobInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
