...
* 
*/
public class WriterQuery extends Query<WriterQuery> {
    WriterQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public WriterQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public WriterQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
