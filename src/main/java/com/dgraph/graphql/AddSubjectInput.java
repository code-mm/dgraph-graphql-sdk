...
public class AddSubjectInput implements Serializable {
    ...
    public AddSubjectInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddSubjectInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddSubjectInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddSubjectInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
