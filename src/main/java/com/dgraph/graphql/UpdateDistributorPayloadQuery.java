...
* 
*/
public class UpdateDistributorPayloadQuery extends Query<UpdateDistributorPayloadQuery> {
    UpdateDistributorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateDistributorPayloadQuery distributor(DistributorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateDistributorPayloadQuery distributor(DistributorArgumentsDefinition argsDef, DistributorQueryDefinition queryDef) {
