...
* 
*/
public class AddCostumeDesignerPayloadQuery extends Query<AddCostumeDesignerPayloadQuery> {
    AddCostumeDesignerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCostumeDesignerPayloadQuery costumedesigner(CostumeDesignerQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCostumeDesignerPayloadQuery costumedesigner(CostumedesignerArgumentsDefinition argsDef, CostumeDesignerQueryDefinition queryDef) {
