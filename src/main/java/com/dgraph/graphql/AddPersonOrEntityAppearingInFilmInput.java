...
public class AddPersonOrEntityAppearingInFilmInput implements Serializable {
    ...
    public AddPersonOrEntityAppearingInFilmInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddPersonOrEntityAppearingInFilmInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddPersonOrEntityAppearingInFilmInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddPersonOrEntityAppearingInFilmInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public AddPersonOrEntityAppearingInFilmInput setFilm(List<FilmRef> film) {
        this.film = Input.optional(film);
        return this;
    }

    public AddPersonOrEntityAppearingInFilmInput setFilmInput(Input<List<FilmRef>> film) {
        if (film == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.film = film;
