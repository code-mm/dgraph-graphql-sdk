...
* 
*/
public class UpdateProductionDesignerPayload extends AbstractResponse<UpdateProductionDesignerPayload> {
    public UpdateProductionDesignerPayload() {
    }

    public UpdateProductionDesignerPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "UpdateProductionDesignerPayload";
    }
    ...
    */
    ...
    public UpdateProductionDesignerPayload setProductiondesigner(List<ProductionDesigner> arg) {
