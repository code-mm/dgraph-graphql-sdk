...
* 
*/
public class UpdateFestivalPayloadQuery extends Query<UpdateFestivalPayloadQuery> {
    UpdateFestivalPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateFestivalPayloadQuery festival(FestivalQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateFestivalPayloadQuery festival(FestivalArgumentsDefinition argsDef, FestivalQueryDefinition queryDef) {
        startField("festival");
