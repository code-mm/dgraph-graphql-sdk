...
public class AddSongInput implements Serializable {
    ...
    public AddSongInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddSongInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddSongInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddSongInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
