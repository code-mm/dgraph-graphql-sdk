...
public class DirectorPatch implements Serializable {
    ...
    public DirectorPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public DirectorPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public DirectorPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public DirectorPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
