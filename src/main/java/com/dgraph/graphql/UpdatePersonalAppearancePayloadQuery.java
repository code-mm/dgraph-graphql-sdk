...
* 
*/
public class UpdatePersonalAppearancePayloadQuery extends Query<UpdatePersonalAppearancePayloadQuery> {
    UpdatePersonalAppearancePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdatePersonalAppearancePayloadQuery personalappearance(PersonalAppearanceQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdatePersonalAppearancePayloadQuery personalappearance(PersonalappearanceArgumentsDefinition argsDef, PersonalAppearanceQueryDefinition queryDef) {
