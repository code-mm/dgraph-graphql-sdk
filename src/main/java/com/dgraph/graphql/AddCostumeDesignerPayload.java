...
* 
*/
public class AddCostumeDesignerPayload extends AbstractResponse<AddCostumeDesignerPayload> {
    public AddCostumeDesignerPayload() {
    }

    public AddCostumeDesignerPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddCostumeDesignerPayload";
    }
    ...
    */
    ...
    public AddCostumeDesignerPayload setCostumedesigner(List<CostumeDesigner> arg) {
