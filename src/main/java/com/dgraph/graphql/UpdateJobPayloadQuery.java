...
* 
*/
public class UpdateJobPayloadQuery extends Query<UpdateJobPayloadQuery> {
    UpdateJobPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateJobPayloadQuery job(JobQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateJobPayloadQuery job(JobArgumentsDefinition argsDef, JobQueryDefinition queryDef) {
        startField("job");
