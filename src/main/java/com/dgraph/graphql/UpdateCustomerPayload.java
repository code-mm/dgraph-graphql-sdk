...
* 
*/
public class UpdateCustomerPayload extends AbstractResponse<UpdateCustomerPayload> {
    public UpdateCustomerPayload() {
    }

    public UpdateCustomerPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public List<Customer> getCustomer() {
        return (List<Customer>) get("customer");
    }

    public UpdateCustomerPayload setCustomer(List<Customer> arg) {
    ...
    */
    ...
    public UpdateCustomerPayload setNumUids(Integer arg) {
