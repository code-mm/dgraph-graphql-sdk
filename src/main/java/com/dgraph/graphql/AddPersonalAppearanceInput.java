...
public class AddPersonalAppearanceInput implements Serializable {
    ...
    public AddPersonalAppearanceInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddPersonalAppearanceInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddPersonalAppearanceInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddPersonalAppearanceInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public AddPersonalAppearanceInput setPerson(List<PersonOrEntityAppearingInFilmRef> person) {
        this.person = Input.optional(person);
        return this;
    }

    public AddPersonalAppearanceInput setPersonInput(Input<List<PersonOrEntityAppearingInFilmRef>> person) {
        if (person == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.person = person;
    ...
    public AddPersonalAppearanceInput setTypeOfAppearance(List<PersonalAppearanceTypeRef> typeOfAppearance) {
        this.typeOfAppearance = Input.optional(typeOfAppearance);
        return this;
    }

    public AddPersonalAppearanceInput setTypeOfAppearanceInput(Input<List<PersonalAppearanceTypeRef>> typeOfAppearance) {
    ...
    public AddPersonalAppearanceInput setAppearances(List<PersonalAppearanceTypeRef> appearances) {
        this.appearances = Input.optional(appearances);
        return this;
    }

    public AddPersonalAppearanceInput setAppearancesInput(Input<List<PersonalAppearanceTypeRef>> appearances) {
        if (appearances == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
