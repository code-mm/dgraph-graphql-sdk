...
* 
*/
public class UpdateDirectorPayloadQuery extends Query<UpdateDirectorPayloadQuery> {
    UpdateDirectorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateDirectorPayloadQuery director(DirectorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateDirectorPayloadQuery director(DirectorArgumentsDefinition argsDef, DirectorQueryDefinition queryDef) {
        startField("director");
