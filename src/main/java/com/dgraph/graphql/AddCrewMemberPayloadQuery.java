...
* 
*/
public class AddCrewMemberPayloadQuery extends Query<AddCrewMemberPayloadQuery> {
    AddCrewMemberPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCrewMemberPayloadQuery crewmember(CrewMemberQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCrewMemberPayloadQuery crewmember(CrewmemberArgumentsDefinition argsDef, CrewMemberQueryDefinition queryDef) {
