...
public class ArtDirectorPatch implements Serializable {
    ...
    public ArtDirectorPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public ArtDirectorPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public ArtDirectorPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public ArtDirectorPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
