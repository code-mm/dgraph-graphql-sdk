...
public class LocationPatch implements Serializable {
    ...
    public LocationPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public LocationPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public LocationPatch setFeaturedInFilms(List<FilmRef> featuredInFilms) {
        this.featuredInFilms = Input.optional(featuredInFilms);
        return this;
    }

    public LocationPatch setFeaturedInFilmsInput(Input<List<FilmRef>> featuredInFilms) {
