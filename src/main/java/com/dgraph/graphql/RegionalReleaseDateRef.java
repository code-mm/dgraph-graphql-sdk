...
public class RegionalReleaseDateRef implements Serializable {
    ...
    public RegionalReleaseDateRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public RegionalReleaseDateRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public RegionalReleaseDateRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public RegionalReleaseDateRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public RegionalReleaseDateRef setReleaseDate(DateTime releaseDate) {
        this.releaseDate = Input.optional(releaseDate);
        return this;
    }

    public RegionalReleaseDateRef setReleaseDateInput(Input<DateTime> releaseDate) {
        if (releaseDate == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public RegionalReleaseDateRef setReleaseRegion(List<LocationRef> releaseRegion) {
        this.releaseRegion = Input.optional(releaseRegion);
        return this;
    }

    public RegionalReleaseDateRef setReleaseRegionInput(Input<List<LocationRef>> releaseRegion) {
