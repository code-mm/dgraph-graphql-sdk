...
public class WriterPatch implements Serializable {
    ...
    public WriterPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public WriterPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public WriterPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public WriterPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
