...
public class WriterRef implements Serializable {
    ...
    public WriterRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public WriterRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public WriterRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public WriterRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public WriterRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public WriterRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
