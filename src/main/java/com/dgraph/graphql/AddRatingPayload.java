...
* 
*/
public class AddRatingPayload extends AbstractResponse<AddRatingPayload> {
    public AddRatingPayload() {
    }

    public AddRatingPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddRatingPayload setRating(List<Rating> arg) {
