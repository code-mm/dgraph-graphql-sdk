...
* 
*/
public class AddProducerPayloadQuery extends Query<AddProducerPayloadQuery> {
    AddProducerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddProducerPayloadQuery producer(ProducerQueryDefinition queryDef) {
    ...
    * 
    */
    public AddProducerPayloadQuery producer(ProducerArgumentsDefinition argsDef, ProducerQueryDefinition queryDef) {
        startField("producer");
