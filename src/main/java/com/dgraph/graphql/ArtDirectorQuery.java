...
* 
*/
public class ArtDirectorQuery extends Query<ArtDirectorQuery> {
    ArtDirectorQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public ArtDirectorQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public ArtDirectorQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
