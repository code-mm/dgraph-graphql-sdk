...
* 
*/
public class AddFestivalEventPayload extends AbstractResponse<AddFestivalEventPayload> {
    public AddFestivalEventPayload() {
    }

    public AddFestivalEventPayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddFestivalEventPayload";
    }
    ...
    */
    ...
    public AddFestivalEventPayload setFestivalevent(List<FestivalEvent> arg) {
