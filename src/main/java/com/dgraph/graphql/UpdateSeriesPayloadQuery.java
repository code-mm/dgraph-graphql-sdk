...
* 
*/
public class UpdateSeriesPayloadQuery extends Query<UpdateSeriesPayloadQuery> {
    UpdateSeriesPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateSeriesPayloadQuery series(SeriesQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateSeriesPayloadQuery series(SeriesArgumentsDefinition argsDef, SeriesQueryDefinition queryDef) {
        startField("series");
