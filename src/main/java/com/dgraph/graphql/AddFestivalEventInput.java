...
public class AddFestivalEventInput implements Serializable {
    ...
    public AddFestivalEventInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddFestivalEventInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddFestivalEventInput setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public AddFestivalEventInput setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddFestivalEventInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddFestivalEventInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
