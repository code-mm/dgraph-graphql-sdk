...
* 
*/
public class UpdateEditorPayloadQuery extends Query<UpdateEditorPayloadQuery> {
    UpdateEditorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateEditorPayloadQuery editor(EditorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateEditorPayloadQuery editor(EditorArgumentsDefinition argsDef, EditorQueryDefinition queryDef) {
        startField("editor");
