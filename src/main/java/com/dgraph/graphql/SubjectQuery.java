...
* 
*/
public class SubjectQuery extends Query<SubjectQuery> {
    SubjectQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public SubjectQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public SubjectQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
