...
public class AddFestivalInput implements Serializable {
    ...
    public AddFestivalInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddFestivalInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddFestivalInput setDateFounded(DateTime dateFounded) {
        this.dateFounded = Input.optional(dateFounded);
        return this;
    }

    public AddFestivalInput setDateFoundedInput(Input<DateTime> dateFounded) {
        if (dateFounded == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddFestivalInput setFocus(List<FestivalFocusRef> focus) {
        this.focus = Input.optional(focus);
        return this;
    }

    public AddFestivalInput setFocusInput(Input<List<FestivalFocusRef>> focus) {
        if (focus == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.focus = focus;
    ...
    public AddFestivalInput setIndividualFestivals(List<FestivalEventRef> individualFestivals) {
        this.individualFestivals = Input.optional(individualFestivals);
        return this;
    }

    public AddFestivalInput setIndividualFestivalsInput(Input<List<FestivalEventRef>> individualFestivals) {
    ...
    public AddFestivalInput setLocation(List<LocationRef> location) {
        this.location = Input.optional(location);
        return this;
    }

    public AddFestivalInput setLocationInput(Input<List<LocationRef>> location) {
        if (location == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddFestivalInput setSponsoringOrganization(List<FestivalSponsorshipRef> sponsoringOrganization) {
        this.sponsoringOrganization = Input.optional(sponsoringOrganization);
        return this;
    }

    public AddFestivalInput setSponsoringOrganizationInput(Input<List<FestivalSponsorshipRef>> sponsoringOrganization) {
