...
public class SeriesPatch implements Serializable {
    ...
    public SeriesPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SeriesPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public SeriesPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SeriesPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
