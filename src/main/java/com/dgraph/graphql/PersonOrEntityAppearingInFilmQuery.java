...
* 
*/
public class PersonOrEntityAppearingInFilmQuery extends Query<PersonOrEntityAppearingInFilmQuery> {
    PersonOrEntityAppearingInFilmQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery id() {
        startField("id");
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery name() {
        startField("name");
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery film(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public PersonOrEntityAppearingInFilmQuery film(FilmArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("film");
