...
* 
*/
public class AddPersonalAppearancePayload extends AbstractResponse<AddPersonalAppearancePayload> {
    public AddPersonalAppearancePayload() {
    }

    public AddPersonalAppearancePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddPersonalAppearancePayload";
    }
    ...
    */
    ...
    public AddPersonalAppearancePayload setPersonalappearance(List<PersonalAppearance> arg) {
