...
public class AddPerformanceInput implements Serializable {
    ...
    public AddPerformanceInput setActor(List<ActorRef> actor) {
        this.actor = Input.optional(actor);
        return this;
    }

    public AddPerformanceInput setActorInput(Input<List<ActorRef>> actor) {
        if (actor == null) {
    ...
    public AddPerformanceInput setCharacter(List<CharacterRef> character) {
        this.character = Input.optional(character);
        return this;
    }

    public AddPerformanceInput setCharacterInput(Input<List<CharacterRef>> character) {
        if (character == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public AddPerformanceInput setCharacterNote(String characterNote) {
        this.characterNote = Input.optional(characterNote);
        return this;
    }

    public AddPerformanceInput setCharacterNoteInput(Input<String> characterNote) {
    ...
    public AddPerformanceInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddPerformanceInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public AddPerformanceInput setSpecialPerformanceType(List<SpecialPerformanceTypeRef> specialPerformanceType) {
        this.specialPerformanceType = Input.optional(specialPerformanceType);
        return this;
    }

    public AddPerformanceInput setSpecialPerformanceTypeInput(Input<List<SpecialPerformanceTypeRef>> specialPerformanceType) {
    ...
    public AddPerformanceInput setAppearances(List<PersonalAppearanceRef> appearances) {
        this.appearances = Input.optional(appearances);
        return this;
    }

    public AddPerformanceInput setAppearancesInput(Input<List<PersonalAppearanceRef>> appearances) {
        if (appearances == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
