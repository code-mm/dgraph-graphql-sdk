...
* 
*/
public class GenreQuery extends Query<GenreQuery> {
    GenreQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public GenreQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public GenreQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
