...
public class JobQuery extends Query<JobQuery> {
    ...
    * 
    */
    public JobQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public JobQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
