...
* 
*/
public class AddRatingSystemPayloadQuery extends Query<AddRatingSystemPayloadQuery> {
    AddRatingSystemPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddRatingSystemPayloadQuery ratingsystem(RatingSystemQueryDefinition queryDef) {
    ...
    * 
    */
    public AddRatingSystemPayloadQuery ratingsystem(RatingsystemArgumentsDefinition argsDef, RatingSystemQueryDefinition queryDef) {
