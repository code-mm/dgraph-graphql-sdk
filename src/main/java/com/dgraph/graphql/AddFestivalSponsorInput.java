...
public class AddFestivalSponsorInput implements Serializable {
    ...
    public AddFestivalSponsorInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddFestivalSponsorInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddFestivalSponsorInput setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public AddFestivalSponsorInput setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
