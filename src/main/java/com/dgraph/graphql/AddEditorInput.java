...
public class AddEditorInput implements Serializable {
    ...
    public AddEditorInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddEditorInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddEditorInput setFilm(List<FilmRef> film) {
        this.film = Input.optional(film);
        return this;
    }

    public AddEditorInput setFilmInput(Input<List<FilmRef>> film) {
        if (film == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.film = film;
