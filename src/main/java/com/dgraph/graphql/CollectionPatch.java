...
public class CollectionPatch implements Serializable {
    ...
    public CollectionPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CollectionPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CollectionPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public CollectionPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
