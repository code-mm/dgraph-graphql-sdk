...
public class FestivalSponsorPatch implements Serializable {
    ...
    public FestivalSponsorPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalSponsorPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public FestivalSponsorPatch setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public FestivalSponsorPatch setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
