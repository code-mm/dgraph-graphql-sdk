...
* 
*/
public class AddPerformancePayloadQuery extends Query<AddPerformancePayloadQuery> {
    AddPerformancePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddPerformancePayloadQuery performance(PerformanceQueryDefinition queryDef) {
    ...
    * 
    */
    public AddPerformancePayloadQuery performance(PerformanceArgumentsDefinition argsDef, PerformanceQueryDefinition queryDef) {
