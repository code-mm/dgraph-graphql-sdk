...
public class CompanyRef implements Serializable {
    ...
    public CompanyRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CompanyRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CompanyRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CompanyRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public CompanyRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public CompanyRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
