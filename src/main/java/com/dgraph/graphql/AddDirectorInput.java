...
public class AddDirectorInput implements Serializable {
    ...
    public AddDirectorInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddDirectorInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddDirectorInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddDirectorInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
