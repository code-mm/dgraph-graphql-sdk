...
* 
*/
public class UpdateSongPerformerPayloadQuery extends Query<UpdateSongPerformerPayloadQuery> {
    UpdateSongPerformerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateSongPerformerPayloadQuery songperformer(SongPerformerQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateSongPerformerPayloadQuery songperformer(SongperformerArgumentsDefinition argsDef, SongPerformerQueryDefinition queryDef) {
