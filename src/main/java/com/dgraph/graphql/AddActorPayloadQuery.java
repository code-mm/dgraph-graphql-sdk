...
* 
*/
public class AddActorPayloadQuery extends Query<AddActorPayloadQuery> {
    AddActorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddActorPayloadQuery actor(ActorQueryDefinition queryDef) {
    ...
    * 
    */
    public AddActorPayloadQuery actor(ActorArgumentsDefinition argsDef, ActorQueryDefinition queryDef) {
        startField("actor");
