...
public class AddFestivalFocusInput implements Serializable {
    ...
    public AddFestivalFocusInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddFestivalFocusInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddFestivalFocusInput setFestivals(List<FestivalRef> festivals) {
        this.festivals = Input.optional(festivals);
        return this;
    }

    public AddFestivalFocusInput setFestivalsInput(Input<List<FestivalRef>> festivals) {
        if (festivals == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
