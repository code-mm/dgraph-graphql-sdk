...
public class CollectionQuery extends Query<CollectionQuery> {
    ...
    * 
    */
    public CollectionQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public CollectionQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
