...
* 
*/
public class AddWriterPayloadQuery extends Query<AddWriterPayloadQuery> {
    AddWriterPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddWriterPayloadQuery writer(WriterQueryDefinition queryDef) {
    ...
    * 
    */
    public AddWriterPayloadQuery writer(WriterArgumentsDefinition argsDef, WriterQueryDefinition queryDef) {
        startField("writer");
