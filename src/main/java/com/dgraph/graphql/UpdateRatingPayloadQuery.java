...
* 
*/
public class UpdateRatingPayloadQuery extends Query<UpdateRatingPayloadQuery> {
    UpdateRatingPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateRatingPayloadQuery rating(RatingQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateRatingPayloadQuery rating(RatingArgumentsDefinition argsDef, RatingQueryDefinition queryDef) {
        startField("rating");
