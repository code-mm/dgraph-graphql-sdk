...
* 
*/
public class AddPersonalAppearanceTypePayload extends AbstractResponse<AddPersonalAppearanceTypePayload> {
    public AddPersonalAppearanceTypePayload() {
    }

    public AddPersonalAppearanceTypePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddPersonalAppearanceTypePayload";
    }
    ...
    */
    ...
    public AddPersonalAppearanceTypePayload setPersonalappearancetype(List<PersonalAppearanceType> arg) {
