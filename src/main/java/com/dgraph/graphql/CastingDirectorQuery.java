...
* 
*/
public class CastingDirectorQuery extends Query<CastingDirectorQuery> {
    CastingDirectorQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public CastingDirectorQuery id() {
        startField("id");
    ...
    * 
    */
    public CastingDirectorQuery name() {
        startField("name");
    ...
    * 
    */
    public CastingDirectorQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public CastingDirectorQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
