...
public class CompanyPatch implements Serializable {
    ...
    public CompanyPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CompanyPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public CompanyPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public CompanyPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
