...
* 
*/
public class UpdateCastingDirectorPayloadQuery extends Query<UpdateCastingDirectorPayloadQuery> {
    UpdateCastingDirectorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCastingDirectorPayloadQuery castingdirector(CastingDirectorQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCastingDirectorPayloadQuery castingdirector(CastingdirectorArgumentsDefinition argsDef, CastingDirectorQueryDefinition queryDef) {
