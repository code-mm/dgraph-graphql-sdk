...
* 
*/
public class FestivalEvent extends AbstractResponse<FestivalEvent> {
    public FestivalEvent() {
    }

    public FestivalEvent(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public FestivalEvent setId(ID arg) {
    ...
    */
    ...
    public FestivalEvent setName(String arg) {
    ...
    */
    ...
    public FestivalEvent setFestivals(List<Festival> arg) {
    ...
    */
    ...
    public FestivalEvent setFilms(List<Film> arg) {
