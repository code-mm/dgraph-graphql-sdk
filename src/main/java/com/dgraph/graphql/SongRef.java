...
public class SongRef implements Serializable {
    ...
    public SongRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public SongRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public SongRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SongRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public SongRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SongRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
