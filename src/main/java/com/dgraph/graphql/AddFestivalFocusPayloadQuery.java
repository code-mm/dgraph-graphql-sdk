...
* 
*/
public class AddFestivalFocusPayloadQuery extends Query<AddFestivalFocusPayloadQuery> {
    AddFestivalFocusPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddFestivalFocusPayloadQuery festivalfocus(FestivalFocusQueryDefinition queryDef) {
    ...
    * 
    */
    public AddFestivalFocusPayloadQuery festivalfocus(FestivalfocusArgumentsDefinition argsDef, FestivalFocusQueryDefinition queryDef) {
