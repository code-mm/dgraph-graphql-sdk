...
* 
*/
public class UpdateLocationPayload extends AbstractResponse<UpdateLocationPayload> {
    public UpdateLocationPayload() {
    }

    public UpdateLocationPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public UpdateLocationPayload setLocation(List<Location> arg) {
