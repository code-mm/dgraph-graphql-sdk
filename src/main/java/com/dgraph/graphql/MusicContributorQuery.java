...
* 
*/
public class MusicContributorQuery extends Query<MusicContributorQuery> {
    MusicContributorQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public MusicContributorQuery id() {
        startField("id");
    ...
    * 
    */
    public MusicContributorQuery name() {
        startField("name");
    ...
    * 
    */
    public MusicContributorQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public MusicContributorQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
