...
public class CrewMemberRef implements Serializable {
    ...
    public CrewMemberRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CrewMemberRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CrewMemberRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CrewMemberRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public CrewMemberRef setFilmsCrewed(List<FilmRef> filmsCrewed) {
        this.filmsCrewed = Input.optional(filmsCrewed);
        return this;
    }

    public CrewMemberRef setFilmsCrewedInput(Input<List<FilmRef>> filmsCrewed) {
        if (filmsCrewed == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
