...
* 
*/
public class AddLocationPayloadQuery extends Query<AddLocationPayloadQuery> {
    AddLocationPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddLocationPayloadQuery location(LocationQueryDefinition queryDef) {
    ...
    * 
    */
    public AddLocationPayloadQuery location(LocationArgumentsDefinition argsDef, LocationQueryDefinition queryDef) {
        startField("location");
