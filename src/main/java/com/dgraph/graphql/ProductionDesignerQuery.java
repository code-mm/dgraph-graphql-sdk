...
* 
*/
public class ProductionDesignerQuery extends Query<ProductionDesignerQuery> {
    ProductionDesignerQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public ProductionDesignerQuery id() {
        startField("id");
    ...
    * 
    */
    public ProductionDesignerQuery name() {
        startField("name");
    ...
    * 
    */
    public ProductionDesignerQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public ProductionDesignerQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
