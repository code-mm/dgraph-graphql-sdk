...
* 
*/
public class AddCompanyPayload extends AbstractResponse<AddCompanyPayload> {
    public AddCompanyPayload() {
    }

    public AddCompanyPayload(JsonObject fields) throws SchemaViolationError {
    ...
    */
    ...
    public AddCompanyPayload setCompany(List<Company> arg) {
