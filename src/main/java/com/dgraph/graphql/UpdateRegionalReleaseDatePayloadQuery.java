...
* 
*/
public class UpdateRegionalReleaseDatePayloadQuery extends Query<UpdateRegionalReleaseDatePayloadQuery> {
    UpdateRegionalReleaseDatePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateRegionalReleaseDatePayloadQuery regionalreleasedate(RegionalReleaseDateQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateRegionalReleaseDatePayloadQuery regionalreleasedate(RegionalreleasedateArgumentsDefinition argsDef, RegionalReleaseDateQueryDefinition queryDef) {
