...
public class SubjectRef implements Serializable {
    ...
    public SubjectRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public SubjectRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public SubjectRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SubjectRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public SubjectRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SubjectRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
