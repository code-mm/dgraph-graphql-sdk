...
public class PersonOrEntityAppearingInFilmPatch implements Serializable {
    ...
    public PersonOrEntityAppearingInFilmPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public PersonOrEntityAppearingInFilmPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public PersonOrEntityAppearingInFilmPatch setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public PersonOrEntityAppearingInFilmPatch setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public PersonOrEntityAppearingInFilmPatch setFilm(List<FilmRef> film) {
        this.film = Input.optional(film);
        return this;
    }

    public PersonOrEntityAppearingInFilmPatch setFilmInput(Input<List<FilmRef>> film) {
        if (film == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.film = film;
