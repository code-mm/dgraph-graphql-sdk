...
* 
*/
public class DistributionMediumQuery extends Query<DistributionMediumQuery> {
    DistributionMediumQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public DistributionMediumQuery id() {
        startField("id");
    ...
    * 
    */
    public DistributionMediumQuery name() {
        startField("name");
    ...
    * 
    */
    public DistributionMediumQuery films(FilmQueryDefinition queryDef) {
    ...
    * 
    */
    public DistributionMediumQuery films(FilmsArgumentsDefinition argsDef, FilmQueryDefinition queryDef) {
        startField("films");
