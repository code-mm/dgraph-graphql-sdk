...
public class FeaturedSongPatch implements Serializable {
    ...
    public FeaturedSongPatch setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FeaturedSongPatch setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public FeaturedSongPatch setFeaturedInFilm(List<FilmRef> featuredInFilm) {
        this.featuredInFilm = Input.optional(featuredInFilm);
        return this;
    }

    public FeaturedSongPatch setFeaturedInFilmInput(Input<List<FilmRef>> featuredInFilm) {
    ...
    public FeaturedSongPatch setPerformedBy(List<FilmRef> performedBy) {
        this.performedBy = Input.optional(performedBy);
        return this;
    }

    public FeaturedSongPatch setPerformedByInput(Input<List<FilmRef>> performedBy) {
        if (performedBy == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
