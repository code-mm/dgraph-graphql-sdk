...
* 
*/
public class AddFestivalSponsorPayloadQuery extends Query<AddFestivalSponsorPayloadQuery> {
    AddFestivalSponsorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddFestivalSponsorPayloadQuery festivalsponsor(FestivalSponsorQueryDefinition queryDef) {
    ...
    * 
    */
    public AddFestivalSponsorPayloadQuery festivalsponsor(FestivalsponsorArgumentsDefinition argsDef, FestivalSponsorQueryDefinition queryDef) {
