...
* 
*/
public class AddArtDirectorPayloadQuery extends Query<AddArtDirectorPayloadQuery> {
    AddArtDirectorPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddArtDirectorPayloadQuery artdirector(ArtDirectorQueryDefinition queryDef) {
    ...
    * 
    */
    public AddArtDirectorPayloadQuery artdirector(ArtdirectorArgumentsDefinition argsDef, ArtDirectorQueryDefinition queryDef) {
