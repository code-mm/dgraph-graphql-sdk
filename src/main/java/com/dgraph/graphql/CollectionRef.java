...
public class CollectionRef implements Serializable {
    ...
    public CollectionRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CollectionRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CollectionRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CollectionRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public CollectionRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public CollectionRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
