...
public class CompanyRoleOrServiceRef implements Serializable {
    ...
    public CompanyRoleOrServiceRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public CompanyRoleOrServiceRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public CompanyRoleOrServiceRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public CompanyRoleOrServiceRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public CompanyRoleOrServiceRef setCompaniesPerformingThisRoleOrService(List<CompanyRef> companiesPerformingThisRoleOrService) {
        this.companiesPerformingThisRoleOrService = Input.optional(companiesPerformingThisRoleOrService);
        return this;
    }

    public CompanyRoleOrServiceRef setCompaniesPerformingThisRoleOrServiceInput(Input<List<CompanyRef>> companiesPerformingThisRoleOrService) {
