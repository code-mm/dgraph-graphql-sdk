...
* 
*/
public class AddRegionalReleaseDatePayload extends AbstractResponse<AddRegionalReleaseDatePayload> {
    public AddRegionalReleaseDatePayload() {
    }

    public AddRegionalReleaseDatePayload(JsonObject fields) throws SchemaViolationError {
    ...
    public String getGraphQlTypeName() {
        return "AddRegionalReleaseDatePayload";
    }
    ...
    */
    ...
    public AddRegionalReleaseDatePayload setRegionalreleasedate(List<RegionalReleaseDate> arg) {
