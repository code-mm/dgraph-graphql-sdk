...
* 
*/
public class UpdateCompanyPayloadQuery extends Query<UpdateCompanyPayloadQuery> {
    UpdateCompanyPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCompanyPayloadQuery company(CompanyQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCompanyPayloadQuery company(CompanyArgumentsDefinition argsDef, CompanyQueryDefinition queryDef) {
        startField("company");
