...
* 
*/
public class AddCinematographerPayloadQuery extends Query<AddCinematographerPayloadQuery> {
    AddCinematographerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCinematographerPayloadQuery cinematographer(CinematographerQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCinematographerPayloadQuery cinematographer(CinematographerArgumentsDefinition argsDef, CinematographerQueryDefinition queryDef) {
