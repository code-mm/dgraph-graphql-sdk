...
* 
*/
public class AddCompanyRoleOrServicePayloadQuery extends Query<AddCompanyRoleOrServicePayloadQuery> {
    AddCompanyRoleOrServicePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddCompanyRoleOrServicePayloadQuery companyroleorservice(CompanyRoleOrServiceQueryDefinition queryDef) {
    ...
    * 
    */
    public AddCompanyRoleOrServicePayloadQuery companyroleorservice(CompanyroleorserviceArgumentsDefinition argsDef, CompanyRoleOrServiceQueryDefinition queryDef) {
