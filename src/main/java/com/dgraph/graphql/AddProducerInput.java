...
public class AddProducerInput implements Serializable {
    ...
    public AddProducerInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddProducerInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddProducerInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddProducerInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
    ...
    public AddProducerInput setFilmsExecutiveProduced(List<FilmRef> filmsExecutiveProduced) {
        this.filmsExecutiveProduced = Input.optional(filmsExecutiveProduced);
        return this;
    }

    public AddProducerInput setFilmsExecutiveProducedInput(Input<List<FilmRef>> filmsExecutiveProduced) {
