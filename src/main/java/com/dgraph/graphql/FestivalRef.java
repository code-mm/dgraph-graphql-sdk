...
public class FestivalRef implements Serializable {
    ...
    public FestivalRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public FestivalRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public FestivalRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public FestivalRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public FestivalRef setDateFounded(DateTime dateFounded) {
        this.dateFounded = Input.optional(dateFounded);
        return this;
    }

    public FestivalRef setDateFoundedInput(Input<DateTime> dateFounded) {
        if (dateFounded == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public FestivalRef setFocus(List<FestivalFocusRef> focus) {
        this.focus = Input.optional(focus);
        return this;
    }

    public FestivalRef setFocusInput(Input<List<FestivalFocusRef>> focus) {
        if (focus == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.focus = focus;
    ...
    public FestivalRef setIndividualFestivals(List<FestivalEventRef> individualFestivals) {
        this.individualFestivals = Input.optional(individualFestivals);
        return this;
    }

    public FestivalRef setIndividualFestivalsInput(Input<List<FestivalEventRef>> individualFestivals) {
    ...
    public FestivalRef setLocation(List<LocationRef> location) {
        this.location = Input.optional(location);
        return this;
    }

    public FestivalRef setLocationInput(Input<List<LocationRef>> location) {
        if (location == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
    ...
    public FestivalRef setSponsoringOrganization(List<FestivalSponsorshipRef> sponsoringOrganization) {
        this.sponsoringOrganization = Input.optional(sponsoringOrganization);
        return this;
    }

    public FestivalRef setSponsoringOrganizationInput(Input<List<FestivalSponsorshipRef>> sponsoringOrganization) {
