...
public class DirectorRef implements Serializable {
    ...
    public DirectorRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public DirectorRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public DirectorRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public DirectorRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public DirectorRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public DirectorRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
