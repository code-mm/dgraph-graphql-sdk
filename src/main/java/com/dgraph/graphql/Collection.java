...
* 
*/
public class Collection extends AbstractResponse<Collection> {
    public Collection() {
    }
    ...
    */
    ...
    public Collection setId(ID arg) {
    ...
    */
    ...
    public Collection setName(String arg) {
    ...
    */
    ...
    public Collection setFilms(List<Film> arg) {
