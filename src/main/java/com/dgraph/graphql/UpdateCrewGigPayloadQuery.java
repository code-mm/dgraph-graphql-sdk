...
* 
*/
public class UpdateCrewGigPayloadQuery extends Query<UpdateCrewGigPayloadQuery> {
    UpdateCrewGigPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCrewGigPayloadQuery crewgig(CrewGigQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCrewGigPayloadQuery crewgig(CrewgigArgumentsDefinition argsDef, CrewGigQueryDefinition queryDef) {
        startField("crewgig");
