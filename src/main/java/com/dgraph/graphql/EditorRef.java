...
public class EditorRef implements Serializable {
    ...
    public EditorRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public EditorRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public EditorRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public EditorRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public EditorRef setFilm(List<FilmRef> film) {
        this.film = Input.optional(film);
        return this;
    }

    public EditorRef setFilmInput(Input<List<FilmRef>> film) {
        if (film == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.film = film;
