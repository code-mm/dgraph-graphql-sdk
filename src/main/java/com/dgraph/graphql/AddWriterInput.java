...
public class AddWriterInput implements Serializable {
    ...
    public AddWriterInput setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public AddWriterInput setNameInput(Input<String> name) {
        if (name == null) {
    ...
    public AddWriterInput setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public AddWriterInput setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
