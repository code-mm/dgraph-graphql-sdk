...
public class SeriesRef implements Serializable {
    ...
    public SeriesRef setId(ID id) {
        this.id = Input.optional(id);
        return this;
    }

    public SeriesRef setIdInput(Input<ID> id) {
        if (id == null) {
    ...
    public SeriesRef setName(String name) {
        this.name = Input.optional(name);
        return this;
    }

    public SeriesRef setNameInput(Input<String> name) {
        if (name == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.name = name;
    ...
    public SeriesRef setFilms(List<FilmRef> films) {
        this.films = Input.optional(films);
        return this;
    }

    public SeriesRef setFilmsInput(Input<List<FilmRef>> films) {
        if (films == null) {
            throw new IllegalArgumentException("Input can not be null");
        }
        this.films = films;
