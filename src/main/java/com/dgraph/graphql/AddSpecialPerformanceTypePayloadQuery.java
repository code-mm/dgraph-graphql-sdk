...
* 
*/
public class AddSpecialPerformanceTypePayloadQuery extends Query<AddSpecialPerformanceTypePayloadQuery> {
    AddSpecialPerformanceTypePayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public AddSpecialPerformanceTypePayloadQuery specialperformancetype(SpecialPerformanceTypeQueryDefinition queryDef) {
    ...
    * 
    */
    public AddSpecialPerformanceTypePayloadQuery specialperformancetype(SpecialperformancetypeArgumentsDefinition argsDef, SpecialPerformanceTypeQueryDefinition queryDef) {
