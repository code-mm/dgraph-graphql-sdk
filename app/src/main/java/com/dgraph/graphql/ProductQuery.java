...
public class ProductQuery extends Query<ProductQuery> {
    ...
    * 
    */
    public ProductQuery reviews(ReviewQueryDefinition queryDef) {
    ...
    * 
    */
    public ProductQuery reviews(ReviewsArgumentsDefinition argsDef, ReviewQueryDefinition queryDef) {
        startField("reviews");
