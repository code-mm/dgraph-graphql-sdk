...
* 
*/
public class UpdateCustomerPayloadQuery extends Query<UpdateCustomerPayloadQuery> {
    UpdateCustomerPayloadQuery(StringBuilder _queryBuilder) {
        super(_queryBuilder);
    }
    ...
    * 
    */
    public UpdateCustomerPayloadQuery customer(CustomerQueryDefinition queryDef) {
    ...
    * 
    */
    public UpdateCustomerPayloadQuery customer(CustomerArgumentsDefinition argsDef, CustomerQueryDefinition queryDef) {
        startField("customer");
    ...
    * 
    */
    public UpdateCustomerPayloadQuery numUids() {
        startField("numUids");
